<div id="container-navbar" class="container-navbar navbar">
    ...
    <div class="l-container-navbar">
        <a href="#" class="sidebar-minimalizer btn btn-theme">
            <i class="fa"></i>
        </a>
    ...
    <div class="r-container-navbar">
        ...
        <!-- Log out -->
        <a class="btn btn-default btn-bordered" href="login.html">
                        ...
                        <ul>
                            ...
                            <li class="right-notifier-element">
                                <div class="row">
                                    ...
                                    <div class="col-xs-10 l-pad-10">
                                        Bitcoin raises 410,00%
                                        <br/>
                                        <small>¿Time to sell?</small>
                                        <br/>
                                        <i>
                                            <small>12/11/2022 10:10h</small>
                                        </i>
                                    </div>
                                </div>
                            </li>
                            ...
                            <li class="right-notifier-element">
                                ...
                                <div class="progress">
                                    <div style="width: 45%;" aria-valuemax="100" aria-valuemin="0"
                                         ...
                                         class="progress-bar progress-bar-info">Server load (45%)
                                    </div>
                                </div>
                                <div class="progress">
                                    <div style="width: 85%;" aria-valuemax="100" aria-valuemin="0"
                                         aria-valuenow="85" role="progressbar"
                                         class="progress-bar progress-bar-danger">Database requests (+85%)
                                    </div>
                                </div>
                                <div class="progress">
                                    <div style="width: 65%;" aria-valuemax="100" aria-valuemin="0"
                                         aria-valuenow="65" role="progressbar"
                                         class="progress-bar progress-bar-warning">Database connections (+65%)
                                    </div>
                                </div>
                            </li>
                            <li class="right-notifier-element">
                            ...
                            <li class="right-notifier-element">
                                <div class="row">
                                    ...
                                    <div class="col-xs-7 l-pad-10">
                                        Ronald C. Stevens
                                        <br/>
                                        <i class="fa fa-circle color-success r-pad-5"></i>
                                        <small>Online</small>
                                    </div>
                            ...
                            <li class="right-notifier-element">
                                <div class="row">
                                    ...
                                    <div class="col-xs-7 l-pad-10">
                                        Laura E. Fagin
                                        <br/>
                                        <i class="fa fa-circle color-danger r-pad-5"></i>
                                        <small>Offline</small>
                                    </div>
                                    <div class="col-xs-3 to-right">
